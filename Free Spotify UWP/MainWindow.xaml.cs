...
namespace Free_Spotify
{
    public sealed partial class MainWindow : Page
    {
        ...
        {
            loadPage.Navigate(typeof(LoadingPageAnimation), null, new SlideNavigationTransitionInfo() { Effect = SlideNavigationTransitionEffect.FromRight });
            await Task.Delay(250);
            loadPage.Navigate(typeof(PlaylistView), null, new SlideNavigationTransitionInfo() { Effect = SlideNavigationTransitionEffect.FromRight });
        }
        #endregion
